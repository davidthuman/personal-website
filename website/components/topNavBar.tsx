...
export default function TopNavBar() {
    return (
        <div className="bg-[#3d3652ff] shadow-xl flex justify-evenly items-center h-20 w-screen fixed top-0 z-50" >
            <Link className='text-white font-body mx-10 md:text-3xl text-2xl' href="/"> DAVID THUMAN </Link>
            <Link className='text-white font-body mx-4 md:text-2xl text-xl' href="code"> CODE </Link>
            <Link className='text-white font-body mx-4 md:text-2xl' href="politics"> POLITICS </Link>
            ...
            <Link className='text-white font-body mx-4 md:text-2xl' href="contact"> CONTACT </Link>
